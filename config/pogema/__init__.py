...
from core.utils import make_pogema
from core.dataset import Transforms
from .env_wrapper import PogemaWrapper
from .model import EfficientZeroNet


class PogemaConfig(BaseConfig):
    def __init__(self, grid_config):
        super(PogemaConfig, self).__init__(
    ...
    def new_game(self, seed=None, save_video=False, save_path=None, video_callable=None, uid=None, test=False, final_test=False):
        ...
        if save_video:
            ...
            env = AnimationMonitor(env, AnimationConfig(directory=save_path))
        return PogemaWrapper(env, discount=self.discount, cvt_string=self.cvt_string)
